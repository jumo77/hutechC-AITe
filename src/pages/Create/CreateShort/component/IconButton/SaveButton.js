import {answers, difficulty, totalScore} from "../../../../../component/const/ForShort";
import {SearchContext} from "../SearchContext";
import {useContext} from "react";

export default function SaveButton(){

    const {problems, metaData, setMetaData, hideShort, setClicked} = useContext(SearchContext)

    const onClick=()=>{
        setMetaData(prev=>({
            ...prev,
            max: totalScore(problems)
        }))
        let i = -1
        let problem = ""
        let valid = true
